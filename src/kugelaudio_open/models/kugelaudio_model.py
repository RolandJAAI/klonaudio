...
class KugelAudioModel(KugelAudioPreTrainedModel):
    def __init__(self, config):
        ...
        # Semantic tokenizer: encodes audio into semantic representations for voice cloning.
        ...
        # Connector for semantic voice embeddings -> LM hidden space
    ...
    def strip_encoders(self):
        ...
        WARNING: This disables voice cloning from audio files. Only use if you
        only need pre-encoded voices.
        ...
        logger.warning(
            "Acoustic and semantic encoders have been stripped. "
...
class KugelAudioForConditionalGeneration(KugelAudioPreTrainedModel):
    ...
    def forward(
        ...
        **kwargs: Optional[Dict[str, Union[torch.Tensor, str]]],
        ...
        # TODO: Semantic features will be integrated in _process_speech_inputs()
