#!/usr/bin/env python3
"""Quick start script for KlonAudio.

This script provides easy access to all KlonAudio functionality:
- Launch the web UI
...
def main():
    parser = argparse.ArgumentParser(
        description="KlonAudio - Open-source text-to-speech with voice cloning",
...
Examples:
  ...
  python start.py verify audio.wav
    ...
    if args.command == "ui":
        print("🎙️ Starting KlonAudio Web Interface...")
        ...
        print(f"🎙️ KlonAudio Speech Generation")
        ...
        if result.detected:
            ...
            print("   This audio was generated by KlonAudio.")
        else:
            print(f"❌ No watermark detected")
            print(f"   Confidence: {result.confidence:.1%}")
            print("   This audio does not appear to be generated by KlonAudio.")
